...
const TRANSMISSIONS = [
  ...
  "BROADCAST-03 · ch.11 · signal clear · no antenna detected on your end",
  "PASSAGE-01 · corridor length: undetermined · do not turn around",
  "FIELD STATION · monitoring active · flatline expected at t+30s",
  "DOCUMENT · 52 pages · most of them blank · read anyway",
  "COMMERCE · four stores · permanently closed · still stocked",
  "SIGNAL CORRUPTED · contents available · decryption: optional",
  "ENDPOINT-9 · white room · you will know it when you see it",
  "ARCHIVE-∞ · aperture unstable · destination: unconfirmed",
  "FREQUENCY SHIFT · new band detected · not on any map",
  "LAB-ECHO · broadcasting on all channels · one spoon",
  "SECTOR 03-Ω · anomaly near archive core · approach recommended",
  "SECTOR 04-Δ · passage detected · length estimates unreliable",
  "SIGNAL LOSS · recovering · please hold",
  "WORMHOLE · coordinates: classified · destination: yes",
  "ANOMALY LOG · objects appear after prolonged observation · keep looking",
  "RELAY-00 · still receiving · not transmitting · for now",
]
