...
export const REGIONS: RegionDef[] = [
  {
    ...
    objects: [
      ...
      { id: 'proj-website',        label: 'DO NOT CATALOG',         type: 'anomaly',  description: 'Recursive object. Self-referencing. Classification suspended.', lore: 'Self-reference detected. Entry count inconsistent.', region: 'projects', href: '/build#website', position: [990, 210, -15],  color: '#93C5FD', size: 18, visible: 'always' },
  ...
  },
  {
    ...
    objects: [
      ...
      { id: 'run-golden',  label: 'GOLDEN GATE',        type: 'fragment', description: 'Trail segment. Dust, rock, variable grade. Survey: incomplete.', region: 'running', href: '/run#golden',  position: [-790, -60, 15],   color: '#FED7AA', size: 18, visible: 'always' },
  ...
  },
  {
    ...
    objects: [
      ...
      { id: 'explore-maroon',    label: 'MAROON BELLS',     type: 'station',  description: 'Survey relay. Multiple peaks. Survey: 2023. Instruments: last calibrated unknown.', region: 'explore', href: '/explore#maroon', position: [580, -540, -10],  color: '#4ADE80', size: 20, visible: 'always' },
