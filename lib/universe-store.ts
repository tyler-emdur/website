...
const PORTAL_GATES: Array<Omit<UniverseObject, 'type' | 'region' | 'visible'>> = [
  ...
  { id: 'gate-10', label: 'LOOP-10',description: 'Interior dimensions inconsistent with exterior.',                    lore: 'Room number is also the world number.',                      worldId: 10, worldPortal: 'vortex',       position: [812, -588, -35], color: '#818CF8', size: 20 },
  ...
  { id: 'gate-12', label: 'TERM-12',       description: 'Terminal interface. Input: unrestricted. Status: active.',             lore: 'Someone left a terminal running.',                           worldId: 12, worldPortal: 'nothing',      position: [611,  844, 28],  color: '#22C55E', size: 20 },
  { id: 'gate-13', label: 'DESCENT-13',      description: 'Infinite descent. No floor contact recorded.',                         lore: 'Branching paths. No map.',                                  worldId: 13, worldPortal: 'vortex',       position: [67,   1027, -56], color: '#6366F1', size: 20 },
  ...
  { id: 'gate-15', label: 'FM-15',     description: 'FM static. Tune until something answers.',                             lore: '88.7 is significant.',                                      worldId: 15, worldPortal: 'chromatic',    position: [-915, -51,  44],  color: '#22C55E', size: 20 },
  { id: 'gate-16', label: 'CATALOG-16',     description: 'Master catalog. Sort order: unverified. Index: incomplete.',           lore: 'List is incomplete.',                                       worldId: 16, worldPortal: 'fold',         position: [-780, -627, -28], color: '#6366F1', size: 20 },
]
