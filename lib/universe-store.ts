...
export const REGIONS: RegionDef[] = [
  ...
  },
  {
    ...
    objects: [
      ...
      { id: 'explore-uncharted', label: 'Uncharted-a / Blank Picnic', type: 'anomaly', description: 'No data available. Approach with a sandwich and suspicion.', region: 'explore', href: '/explore#uncharted', position: [430, -680, 30], color: '#86EFAC', size: 16, visible: { visited: 3 } },
      { id: 'explore-hidden', label: 'Signal-09 / Fern Fax', type: 'signal', description: 'Faint transmission. Coordinates encoded in a leaf-shaped mistake.', region: 'explore', href: '/explore#signal', position: [600, -620, -25], color: '#22C55E', size: 8, visible: { time: 45000 } },
    ]
  },
  {
    id: 'lab',
