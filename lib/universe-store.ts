...
export const REGIONS: RegionDef[] = [
  {
    ...
    objects: [
      { id: 'proj-digger',         label: 'INDEX-DIGGER',           type: 'planet',   description: 'System query frequency: elevated. Log size: 1.4TB. Method of categorization: unresolved.', lore: 'Index tracking continues. Query logs show requests without source addresses.', region: 'projects', worldId: 5, worldPortal: 'newspaper', position: [1600, 400, -80],   color: '#60A5FA', size: 28, visible: 'always' },
      { id: 'proj-website',        label: 'RECURSIVE-∅',            type: 'anomaly',  description: 'Self-referencing structure. Nested node count: unstable. Integrity check: suspended.', lore: 'Recursive loops detected in segment headers. Readouts match system root.', region: 'projects', worldId: 5, worldPortal: 'newspaper', position: [1750, 520, -120],  color: '#93C5FD', size: 18, visible: 'always' },
      { id: 'proj-faraday',        label: 'FARADAY-RECEPTOR',       type: 'planet',   description: 'Signal source unresolved. Arrival timestamp predates index establishment. Solar load: critical.', lore: 'No establishment log. Sensor records trace energy fluctuations to 2018.', region: 'projects', worldId: 5, worldPortal: 'newspaper', position: [1420, 280, -70],    color: '#1D4ED8', size: 22, visible: 'always' },
      ...
      { id: 'proj-endpoint',       label: 'TERMINATION-POINT',      type: 'signal',   description: 'Final telemetry coordinates before carrier wave collapse. Signal level: -94dB.', lore: 'Transmission terminated. Telemetry log ends — but a machine at the coordinate is still receiving.', region: 'projects', worldId: 9, worldPortal: 'expand-white', position: [1980, 200, -60],   color: '#E5E5E5', size: 7,  visible: { visited: 6 } },
      { id: 'proj-loop',           label: 'SYSTEM-LOOP-10',         type: 'wormhole', description: 'Aperture dimension matches internal sequence. Geometry: non-Euclidean.', lore: 'Index coordinates redirect here. TRAVERSE WITH EXTREME CAUTION.', region: 'projects', worldId: 5, worldPortal: 'vortex', position: [1680, 290, -110],   color: '#818CF8', size: 30, visible: { visited: 4 } },
    ]
  },
  {
    id: 'running',
